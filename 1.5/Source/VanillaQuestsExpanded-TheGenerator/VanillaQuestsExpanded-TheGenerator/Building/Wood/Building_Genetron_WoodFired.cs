...
namespace VanillaQuestsExpandedTheGenerator
{
    public class Building_Genetron_WoodFired : Building_Genetron
    {
        ...
        public override IEnumerable<Gizmo> GetGizmos()
        {
            ...
            {
                command_Action.defaultDesc = "VQE_InstallWoodFueledGenetronDesc".Translate()+"VQE_InstallWoodFueledGenetronDescExpanded".Translate(totalFuelBurnedToUpdate,totalFuelBurned);
                command_Action.defaultLabel = "VQE_InstallWoodFueledGenetron".Translate();
                command_Action.icon = ContentFinder<Texture2D>.Get("UI/Gizmos/UpgradeGenetron_Gizmo_2", true);
            ...
            command_Action2.defaultLabel = "VQE_DowngradeGenetron".Translate(InternalDefOf.VQE_Genetron_Basic.LabelCap);
            command_Action2.icon = ContentFinder<Texture2D>.Get("UI/Gizmos/DowngradeGenetron_Gizmo_0", true);
            command_Action2.hotKey = KeyBindingDefOf.Misc2;
            command_Action2.action = delegate
            {
                Window_Downgrade downgradeWindow = new Window_Downgrade(this, InternalDefOf.VQE_Genetron_Basic);
